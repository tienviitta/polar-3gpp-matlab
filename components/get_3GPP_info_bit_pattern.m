...
% C = setdiff (A, B): Return the unique elements in A that are not in B. The default is "sorted" and values in the output are placed in ascending order.
...
%% C = setdiff (..., "stable"): The alternative "stable" preserves the order found in the input.
