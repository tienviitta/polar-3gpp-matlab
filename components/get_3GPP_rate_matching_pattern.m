...
% 5.4.1.1 Sub-block interleaving: The bits input to the sub-block interleaver are the coded bits d
d = 1:N;

% 5.4.1.1 Sub-block interleaving: The bits output from the sub-block interleaver are denoted as y
J = zeros(1,N);
y = zeros(1,N);
for n=0:N-1
    i=floor(32*n/N);
