function [rate_matching_pattern, mode] = get_BIVP_rate_matching_pattern(N,E)
% GET_BIVP_RATE_MATCHING_PATTERN Get the Bit Reversed Puncturing (BIVP) 
...
%   of 0.
%
%   See also GET_BIVS_RATE_MATCHING_PATTERN, GET_NATP_RATE_MATCHING_PATTERN 
%   and GET_NATS_RATE_MATCHING_PATTERN
%
...
rate_matching_pattern = sort(bin2dec(fliplr(dec2bin(N-E:N-1,log2(N)))))'+1;
mode = 'puncturing';