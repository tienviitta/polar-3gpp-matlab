function [rate_matching_pattern, mode] = get_BIVS_rate_matching_pattern(N,E)
% GET_BIVS_RATE_MATCHING_PATTERN Get the Bit Reversed Shortening (BIVS) 
...
%   of 0.
%
%   See also GET_BIVP_RATE_MATCHING_PATTERN, GET_NATP_RATE_MATCHING_PATTERN 
...
rate_matching_pattern = sort(bin2dec(fliplr(dec2bin(0:E-1,log2(N)))))'+1;
mode = 'shortening';